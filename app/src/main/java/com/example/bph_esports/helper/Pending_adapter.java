...
public class Pending_adapter extends RecyclerView.Adapter<Pending_adapter.ViewHolder> {
    ...
    public Pending_adapter(ArrayList<history_list> coursesArrayList, Context context) {
    ...
    public Pending_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Pending_adapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.mm_list, parent, false));
    }
